...
echo '<script>alert("Sorry Password cannot be changed, for testing purposes.")</script>';
                            ...
                            <div class="block block-themed">
                                ...
                                <div class="block-content">
                                    <form method="post" onsubmit="return checkpass();" name="changepassword">
                                        ...
                                        <p>Note: It wont allow you for password change, only for testing purposes.</p>
                                    </form>
                                </div>
                            </div>
